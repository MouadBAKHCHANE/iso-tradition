                  ...
                  if (link.dropdown) {
                    return (
                      <div key={link.label} className="relative group">
                        <Tag
                          href={link.href}
                          className="font-medium text-[12px] lg:text-[12px] xl:text-[14px] 2xl:text-[16px] text-primary/70 hover:text-primary transition-colors relative after:absolute after:bottom-[-3px] after:left-0 after:h-[2px] after:w-0 hover:after:w-full after:bg-accent after:transition-all whitespace-nowrap flex items-center gap-1"
                        >
                          {link.label}
