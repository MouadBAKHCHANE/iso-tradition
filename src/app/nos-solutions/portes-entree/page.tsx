...
const product = {
  ...
  whyImage: "/images/products/portes-entree/why.jpg",
  advantagesImage: "/images/products/portes-entree/advantages.jpg",
  advantages: [
  ...
  personalisationOptions: [
    { 
      ...
      items: [
        ...
        { name: "Cintrée", image: "/images/icons/ronde.png" }
      ] 
    },
    { 
      icon: "motifs", 
      label: "Motifs", 
      items: [
        { name: "Motifs décoratifs", image: "/images/icons/config.png" }
      ] 
    },
    { 
      icon: "couleurs", 
      label: "Couleurs", 
      items: [
        { name: "Couleurs RAL", image: "/images/icons/couleurs.png" }
      ] 
    },
  ],
  types: [
    { name: "PVC", description: "Pratique, économique et facile à entretenir. Isolation thermique efficace, idéal pour les maisons modernes ou rénovations.", image: "/images/products/portes-entree/pvc.jpg" },
    { name: "Aluminium", description: "Design moderne, robustesse et durabilité. Profilés fins et design épuré, excellente résistance aux intempéries.", image: "/images/products/portes-entree/alu-v2.jpg" },
    { name: "Bois", description: "Chaleur, authenticité et prestige naturel. Esthétique chaleureuse et traditionnelle, isolation naturelle et confortable.", image: "/images/products/portes-entree/bois-v2.jpg" },
    { name: "Bois-Aluminium", description: "Esthétique et performance réunies. Bois à l'intérieur pour la chaleur, aluminium à l'extérieur pour la protection.", image: "/images/products/portes-entree/bois-alu-v3.jpg" },
  ],
